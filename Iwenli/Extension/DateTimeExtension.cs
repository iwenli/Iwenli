 ...
 * 
 *  文 件 名：DateTimeExtension
 *  所属项目：System
 *  创建用户：iwenli(HouWeiya)
 *  创建时间：2018/5/21 16:01:57
 *  
 *  功能描述：
 *          1、
 * 
...
namespace System
{
    ...
    public static class DateTimeExtension
    {
        ...
        /// <summary>
        /// 获得 <paramref name="dt" /> 对应的Javascript时间刻度(13位时间戳)
        /// </summary>
        ...
        /// <summary>
        /// 获得 <paramref name="dt"/> 对应的Unix时间戳(10位时间戳)
        /// </summary>
        ...
        /// 时间戳转时间
        /// </summary>
        /// <param name="jsTicks">13位时间戳</param>
        /// <returns></returns>
        public static DateTime ToDatetimeFromJsTicks(this long jsTicks)
        {
            return TimeZone.CurrentTimeZone.ToLocalTime(JsTicksStartBase).AddMilliseconds(jsTicks);
        }

        /// <summary>
        /// 时间戳转时间
        /// </summary>
        /// <param name="unixTicks">10位时间戳</param>
        /// <returns></returns>
        public static DateTime ToDatetimeFromUnixTicks(this long unixTicks)
        {
            return TimeZone.CurrentTimeZone.ToLocalTime(JsTicksStartBase).AddSeconds(unixTicks);
        }
