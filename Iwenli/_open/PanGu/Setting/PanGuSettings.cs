...
namespace PanGu.Setting
{
    ...
    public class PanGuSettings
    {
        ...
        { 
            ...
            //目录处理，MrLee2017-05-09
            if (!System.IO.Directory.Exists(_path))
            {
                _path = AppDomain.CurrentDomain.BaseDirectory + DictionaryPath;
                if (!System.IO.Directory.Exists(_path))
                {
            ...
            LogHelper.GetLogger("PanGu").Info("词典路径【" + DictionaryPath + "】：" + _path);

            return Path.AppendDivision(_path, '\\');
        }
