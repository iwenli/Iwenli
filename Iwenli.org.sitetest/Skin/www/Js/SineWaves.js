...
$(document).ready(function () {
    function a() {
        ...
        fmhPara = $(".feature-mi").height() < 641 || $(".feature-ai").height() < 641 || $(".feature-bi").height() < 641 ? 0 : 1,
            768 > a ? ($(".mi-headline-bg").css("height", $(".feature-mi").height() + 28 * b * c + "px"),
                $(".ai-headline-bg").css("height", $(".feature-ai").height() + 28 * b * c + "px"),
                $(".bi-headline-bg").css("height", $(".feature-bi").height() + 28 * b * c + "px"),
                $(".ee-headline-bg").css("height", $(".feature-ee").height() + parseInt($(".feature-ee").css("padding-top")) + 20 * b + "px")) : ($(".mi-headline-bg").removeAttr("style"),
    ...
    $(function () {
        var a = new SineWaves({
            ...
            width: function () {
                ...
                return a; //768 > a ? 3 * $("#waves").parent().width() : 1.4 * $("#waves").parent().width()
            },
            height: function () {
            ...
            resizeEvent: function () {
                ...
                a.addColorStop(0, "rgba(0, 255, 0, 0.9)"),
                    a.addColorStop(.5, "rgba(0, 255, 0, 0.6)"),
                    a.addColorStop(1, "rgba(0, 255, 0, 0.6)");
    ...
    $(function () {
        var a = new SineWaves({
            ...
            resizeEvent: function () {
                var a = this.ctx.createLinearGradient(0, 0, this.width, 0);
                a.addColorStop(0, "rgba(0, 255, 0, 0)"),
                    a.addColorStop(.5, "rgba(0, 255, 0, 0.2)"),
                    a.addColorStop(1, "rgba(0, 255, 0, 0)");
                for (var b = -1, c = this.waves.length; ++b < c;)
                    this.waves[b].strokeStyle = a;
                b = void 0,
                    c = void 0,
